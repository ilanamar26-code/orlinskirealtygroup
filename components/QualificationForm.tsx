...
export function QualificationForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-stone/10 rounded-lg p-8 text-center space-y-4">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-stone/30 rounded-lg bg-offwhite text-black focus:outline-none focus:ring-2 focus:ring-gold"
          />
        </div>
      ...
      <button
        ...
        className="w-full px-8 py-4 bg-black text-offwhite rounded-lg font-medium hover:bg-graphite transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
